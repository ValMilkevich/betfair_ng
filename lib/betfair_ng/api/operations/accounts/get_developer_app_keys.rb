      ...
      module Accounts
        ...
        module GetDeveloperAppKeys
          ...
          class Response < Base::Response
            field :result, type: "BetfairNg::API::DataTypes::List", of: "BetfairNg::API::DataTypes::DeveloperApp"
          end
          ...
          class Operation < Base::Operation
            configure do |operation|
              operation.name = "AccountAPING/v1.0/getDeveloperAppKeys"
