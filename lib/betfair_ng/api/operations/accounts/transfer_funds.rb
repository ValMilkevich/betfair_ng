      ...
      module Accounts
        ...
        module TransferFunds
          ...
          class Request < Base::Request
            ...
            field :from, type:  "BetfairNg::API::DataTypes::Enums::Wallet", required: true, default: true
            field :to, type:  "BetfairNg::API::DataTypes::Enums::Wallet", required: true
            field :amount, type:  Float, required: true
          end

          #  Declares class for Response Handler for Cancel Order operation
          #
          class Response < Base::Response
            field :result, type: "BetfairNg::API::DataTypes::TransferResponse"
          end
          ...
          class Operation < Base::Operation
            configure do |operation|
              operation.name = "AccountAPING/v1.0/transferFunds"
