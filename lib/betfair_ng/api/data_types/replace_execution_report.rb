module BetfairNg
	...
	module API
		...
		module DataTypes
			...
			#  Declares ReplaceExecutionReport
			#
			# == Fields
			#  - customer_ref
			#  - status
			...
			#  - instruction_reports
			#
			class ReplaceExecutionReport < Base
				...
				# @!attribute [w]
				#
				field :instruction_reports, type: BetfairNg::API::DataTypes::List, of: "BetfairNg::API::DataTypes::ReplaceInstructionReport", required: false
