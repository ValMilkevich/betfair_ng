module BetfairNg
	...
	module API
		...
		module DataTypes
			...
			#  - instruction_reports
			#
			class PlaceExecutionReport < Base
				...
				# @!attribute [w]
				#
				field :instruction_reports, type: BetfairNg::API::DataTypes::List, of: "BetfairNg::API::DataTypes::PlaceInstructionReport", required: false
