...
describe BetfairNg::API::Operations::Betting::PlaceOrders do
  ...
  describe "Operation" do
    ...
    subject { BetfairNg::API::Operations::Betting::PlaceOrders::Operation.new( config: config, session: session ) }
