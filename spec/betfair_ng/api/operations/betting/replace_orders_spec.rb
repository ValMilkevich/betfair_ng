...
describe BetfairNg::API::Operations::Betting::ReplaceOrders do
  ...
  describe "Operation" do
    ...
    subject { BetfairNg::API::Operations::Betting::ReplaceOrders::Operation.new( config: config, session: session ) }
