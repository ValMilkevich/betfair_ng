...
describe BetfairNg::API::Operations::Betting::UpdateOrders do
  ...
  describe "Operation" do
    ...
    subject { BetfairNg::API::Operations::Betting::UpdateOrders::Operation.new( config: config, session: session ) }
